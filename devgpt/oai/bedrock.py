...
class BedrockClient:
    ...
    def create(self, params):
        """Run Amazon Bedrock inference and return DevGpt response"""
...
def oai_messages_to_bedrock_messages(
    ...
    This is the same method as the one in the Devgpt Anthropic client
    """
...
def format_tool_calls(content):
    """Converts Converse API response tool calls to DevGpt format"""
    tool_calls = []
